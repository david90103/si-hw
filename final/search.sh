...
FUNCTIONS_EVAL_300000=("Michalewicz" "Schwefel")
...
for f in "${FUNCTIONS_EVAL_300000[@]}"
do
    ./main gwoex $f $DIMENSION $RUN $ITERATION 300000 "" $POPULATION
    ./main gwo   $f $DIMENSION $RUN $ITERATION 300000 "" $POPULATION
    ./main pso   $f $DIMENSION $RUN $ITERATION 300000 "" $POPULATION 0.4 0.8 0.8
    ./main de    $f $DIMENSION $RUN $ITERATION 300000 "" $POPULATION 0.4 0.6
done
